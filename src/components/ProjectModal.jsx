            ...
            <div className="pt-4 border-t border-gray-700 flex flex-wrap gap-3">
              ...
              {project.github && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 border-2 border-teal-500 text-teal-400 hover:bg-teal-500 hover:text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105"
                >
